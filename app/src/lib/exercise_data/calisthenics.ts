...
export const calisthenicsExercises: ExerciseDetails[] = [
	{
		...
		description:
			'A push-up variation where hands are placed close together forming a diamond shape, emphasizing triceps engagement.',
		metrics: {
			hasSets: true,
			hasReps: true,
			hasWeight: false,
	...
	},
	{
		...
		description:
			'A push-up variation where you keep your elbows close to your body and focus on tricep extension at the top of the movement.',
		metrics: {
			hasSets: true,
			hasReps: true,
			hasWeight: false,
	...
	},
	{
		...
		muscles: [Muscles.CHEST, Muscles.TRICEPS, Muscles.SHOULDERS],
		description:
			'A push-up with hands placed shoulder-width apart or slightly closer, increasing tricep engagement.',
		metrics: {
			hasSets: true,
			hasReps: true,
			hasWeight: false,
	...
	},
	{
		...
		description:
			'A bodyweight exercise performed using a chair or bench, primarily targeting the triceps through dipping motion.',
		metrics: {
			hasSets: true,
			hasReps: true,
			hasWeight: false,
